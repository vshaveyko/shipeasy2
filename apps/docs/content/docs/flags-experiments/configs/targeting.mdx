...
<ConvertCTA
  ...
  title={
    <>
      Promote to an <em>experiment</em>.
    </>
  }
  body="When you want a defensible answer (not just a ramp), turn the gate into an A/B test and let ShipEasy run the statistics."
  primaryHref="/flags-experiments/experiments"
...
<DocNav
  prev={{ href: "/flags-experiments/configs/values", title: "Dynamic values" }}
