      ...
      <PageBody className="space-y-6">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <StatCard
            label="Verdict"
            value={verdict}
            hint="Outcome based on p-value and SRM checks"
          />
        </div>
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          <Card>
            ...
            <CardContent className="pt-4 text-sm text-muted-foreground">
              {plan?.cuped_enabled ? (
                <p>
                  CUPED variance reduction is enabled for this project. Pre-experiment covariates
                  are captured at experiment start.
                </p>
              ) : (
                <p>
                  CUPED variance reduction is available on Pro plan and above. Upgrade to reduce
                  noise and detect smaller effects.
                </p>
              )}
            </CardContent>
          </Card>
